...
namespace i2c::driver
{
    ...
    struct Linux {
        ...
        void write(const handle_type& handle, std::contiguous_iterator auto buffer_begin, std::contiguous_iterator auto buffer_end) const
        {
        ...
        template<byte T>
        void read(const handle_type& handle, contiguous_output_iterator<T> auto buffer_begin, contiguous_output_iterator<T> auto buffer_end) const
        {
